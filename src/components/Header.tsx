...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 shadow-sm">
        <div className="mx-auto flex max-w-7xl items-center bg-white px-6 pt-4 lg:px-8">
          <Link href="/" className="flex items-center gap-2">
            <img src="/rbs_logo.png" alt="Rosewood Body Shop" className="h-15 w-auto" />
          </Link>
          <nav className="mx-auto flex max-w-7xl items-center justify-center gap-8 px-6 pb-3 pt-2 lg:px-8">
            {/* Desktop nav */}
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="https://www.facebook.com/rosewoodbodyshop"
              target="_blank"
